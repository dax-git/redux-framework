...
if ( !class_exists ( 'ReduxFramework' ) ) {
    ...
    class ReduxFramework {
        ...
        public static $_version = '3.4.3.1';
        public static $_dir;
        public static $_url;
...
// __construct()
        ...
        private function set_default_args () {
            $this->args = array(
                ...
                'ajax_save' => false,
                    // Use the panel ajax save or not.
            );
        }
        ...
        public function _options_page () {
            ...
            if ( $this->args[ 'menu_type' ] == 'hidden' ) {
                ...
                $this->page = add_menu_page (
                        $this->args[ 'page_title' ], $this->args[ 'menu_title' ], $this->args[ 'page_permissions' ], $this->args[ 'page_slug' ], array( &$this, 'generate_panel' ), $this->args[ 'menu_icon' ], $this->args[ 'page_priority' ]
                );
...
//                            }
                        ...
                        if ( !$display || isset ( $this->no_panel_section[ $k ] ) ) {
                            ...
                            add_settings_field (
                                    "{$fieldk}_field", $th, array( &$this, '_field_input' ), "{$this->args[ 'opt_name' ]}{$k}_section_group", "{$this->args[ 'opt_name' ]}{$k}_section", $field
                            ); // checkbox
                        }
                    }
                }
