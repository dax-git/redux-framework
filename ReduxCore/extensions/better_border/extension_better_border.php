...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_better_border' ) ) {


    /**
     * Main ReduxFramework better_border extension class
     *
     * @since       1.0.0
     */
    class ReduxFramework_extension_better_border {
