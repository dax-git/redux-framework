...
(function( $ ) {
    ...
    redux.field_objects.better_color_gradient = redux.field_objects.better_color_gradient || {};
    ...
    redux.field_objects.better_color_gradient.init = function( selector ) {

        if ( !selector ) {
            selector = $( '#redux-form-wrapper' ).find( 'fieldset.redux-container-better_color_gradient' );
        }
