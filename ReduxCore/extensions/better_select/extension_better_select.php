...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_better_select' ) ) {


    /**
     * Main ReduxFramework better_select extension class
     *
     * @since       1.0.0
     */
    class ReduxFramework_extension_better_select {
