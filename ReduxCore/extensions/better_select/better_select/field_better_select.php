...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'ReduxFramework_better_select' ) ) {
        class ReduxFramework_better_select {
             ...
             */
            function render() {
                $sortable = ( isset( $this->field['sortable'] ) && $this->field['sortable'] ) ? ' select2 select2-sortable"' : "";
                ...
                if ( ! empty( $this->field['data'] ) && empty( $this->field['options'] ) ) {
                    ...
                    if ( $this->field['data'] == "elusive-icons" || $this->field['data'] == "elusive-icon" || $this->field['data'] == "elusive" ) {
                        $icons_file = $this->extension_dir . 'elusive-icons.php';
                        /**
                    ...
                    if ( $this->field['data'] == "fontawesome-icons" || $this->field['data'] == "fontawesome-icon" || $this->field['data'] == "fontawesome" ) {
                        $icons_file = $this->extension_dir . 'fontawesome-icons.php';
                        /**
                         * filter 'redux-font-icons-file}'
                         *
                         * @param  array $icon_file File for the icons
                ...
                if ( ! empty( $this->field['data'] ) && ( ( $this->field['data'] == "elusive-icons" || $this->field['data'] == "elusive-icon" || $this->field['data'] == "elusive" ) || ( $this->field['data'] == "fontawesome-icons" || $this->field['data'] == "fontawesome-icon" || $this->field['data'] == "fontawesome" ) ) ) {
                    $this->field['class'] = " select2 font-icons";
                }
                //if
                ...
                if ( ! empty( $this->field['options'] ) ) {
                    ...
                    echo '<select ' . $multi . ' id="' . $this->field['id'] . '-better_select" data-placeholder="' . $placeholder . '" name="' . $this->field['name'] . $this->field['name_suffix'] . $nameBrackets . '" class="redux-better_select-item ' . $this->field['class'] . $sortable . '"' . $width . ' rows="6">';
            ...
            function enqueue() {
                ...
                wp_enqueue_script(
                    'field-better_select-js',
                    $this->extension_url . 'field_better_select.js',
                ...
                wp_enqueue_style(
                    'redux-field-better_select-css',
                    $this->extension_url . 'field_better_select.css',
                    time(),
                    true
                );
